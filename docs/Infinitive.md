...
亦即，将语气助动词改写为 to，就可以把限定动词短语（语气助动词 + 原形动词）改为非限定（to + V），也就是把动词短语转变为其他词类使用。

像现在分词、过去分词、动名词一样，不定式短语也是传统语法所谓「动状词」的一种，或称非限定动词。

如果不定式短语的构造简单（例如只有 to + V），可以直接视为动词短语（语气助动词+ 原形动词）的词类变化看待：把语气助动词变成表示不定式的 to，那么原本的动词短语就转变成不定式短语，可以当作名词、形容词、或者副词使用。
