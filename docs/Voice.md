...
传统语法是把 be + Ven（如was invaded）当成被动态的动词片语看待，不过比较简单的看法是直接认定be为动词、后面的 Ven 为表达被动语态的形容词补语。原来的主词（如 the US）如果需要交代，可以放在介系词 by 后面当受词、构成一个介系词片语的修饰语（by the US）。这种可有可无的修饰语也可以省略。
